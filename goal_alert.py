...
def main():
    ...
    for match in fixtures:
        ...
        # Ensure state entry for this fixture
        ...
        for event in events:
            if event["type"] == "Goal":
                event_id = event["time"]["elapsed"]  # not unique enough; use combination
                # Unique key: minute + extra + player name (safer)
        ...
        # Sort goals by minute for a natural order if multiple
